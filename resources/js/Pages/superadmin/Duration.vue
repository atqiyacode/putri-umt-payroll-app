...
<template>
  <Head title="Duration" />
  <TopBar name="Duration" :canBack="true" :url="route('master.data')"></TopBar>
            ...
            <div class="mb-2">
              ...
              <div class="p-fluid">
                <p-input-text
                  ...
                  :class="
                    v$.form.label.$error ? 'p-invalid is-invalid' : 'p-valid'
                  "
                />
              </div>
...
export default {
  ...
  methods: {
    ...
    saveData() {
      ...
      if (!this.v$.$error) {
        axios
          .post(route("duration.store"), this.form)
          .then((result) => {
            this.$toast.add({
              severity: "success",
              summary: "Success",
    ...
    updateData() {
      axios
        .put(route("duration.update", this.form.id), this.form)
        .then((result) => {
          this.$toast.add({
            severity: "success",
            summary: "Success",
    ...
    deleteData(event, id) {
      this.$confirm.require({
        ...
        accept: () => {
          axios
            .delete(route("duration.destroy", id))
            .then((result) => {
              this.$toast.add({
                severity: "success",
                summary: "Success",
