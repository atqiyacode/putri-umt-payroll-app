...
<template>
  <Head title="Division" />
  <TopBar name="Division" :canBack="true" :url="route('master.data')"></TopBar>
...
export default {
  ...
  methods: {
    ...
    saveData() {
      ...
      if (!this.v$.$error) {
        axios
          .post(route("division.store"), this.form)
          .then((result) => {
            this.$toast.add({
              severity: "success",
              summary: "Success",
    ...
    updateData() {
      axios
        .put(route("division.update", this.form.id), this.form)
        .then((result) => {
          this.$toast.add({
            severity: "success",
            summary: "Success",
    ...
    deleteData(event, id) {
      this.$confirm.require({
        ...
        accept: () => {
          axios
            .delete(route("division.destroy", id))
            .then((result) => {
              this.$toast.add({
                severity: "success",
                summary: "Success",
