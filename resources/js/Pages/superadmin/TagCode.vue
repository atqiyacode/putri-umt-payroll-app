...
<template>
  <Head title="Tag Code" />
  <TopBar name="Tag Code" :canBack="true" :url="route('master.data')"></TopBar>
...
export default {
  ...
  methods: {
    ...
    saveData() {
      ...
      if (!this.v$.$error) {
        axios
          .post(route("tagCode.store"), this.form)
          .then((result) => {
            this.$toast.add({
              severity: "success",
              summary: "Success",
    ...
    updateData() {
      axios
        .put(route("tagCode.update", this.form.id), this.form)
        .then((result) => {
          this.$toast.add({
            severity: "success",
            summary: "Success",
    ...
    deleteData(event, id) {
      this.$confirm.require({
        ...
        accept: () => {
          axios
            .delete(route("tagCode.destroy", id))
            .then((result) => {
              this.$toast.add({
                severity: "success",
                summary: "Success",
