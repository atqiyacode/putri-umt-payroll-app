...
$(function() {
    ...
    function setup() {
        ...
        if ($('body').hasClass('dark-skin')) {
            $('[data-layout="dark-skin"]').attr('checked', 'checked')
        }
    ...
    $('[data-toggle="push-menu"]').on('click', function() {
        ...
        if ($sidebar.hasClass('sidebar-collapse')) {
            setLayoutSidebar('sidebar-open')
        } else {
            setLayoutSidebar('sidebar-collapse')
        }
    })

    function setLayoutTheme(type) {
        $.ajax({
            type: 'get',
            url: `/theme/${type}`,
            dataType: "json",
    ...
    function setLayoutSidebar(type) {
        $.ajax({
            type: 'get',
            url: `/sidebar/${type}`,
            dataType: "json",
